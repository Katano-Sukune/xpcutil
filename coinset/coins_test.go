...
import (
	...
	"github.com/Katano-Sukune/xpcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    xpcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() xpcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value xpcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = xpcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = xpcutil.NewTxFromBytes(testSimpleCoinTxBytes)
